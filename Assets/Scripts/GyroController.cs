...
sealed class GyroController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Quaternion zQuatController = Quaternion.AngleAxis(_accGyro.eulerAngles.z, Vector3.forward);
        ...
        //print("X: " + xQuatTotal.x + ", " + xQuatTotal.y + ", " + xQuatTotal.z + ", " + xQuatTotal.w);
        //print("Y: " + yQuatTotal.x + ", " + yQuatTotal.y + ", " + yQuatTotal.z + ", " + yQuatTotal.w);
        //print("Z: " + zQuatController.x + ", " + zQuatController.y + ", " + zQuatController.z + ", " + zQuatController.w);
